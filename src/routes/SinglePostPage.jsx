    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col md:flex-row gap-12 justify-between">
        ...
        <div className="lg:text-lg flex flex-col gap-6 text-justify">
          {/* Static dummy content paragraphs removed here for clarity, keep them in your file */}
          <p className="whitespace-pre-wrap">{data.content || "No content provided."}</p> 
        </div>
        {/* menu */}
        <div className="px-4 h-max sticky top-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-8">
              {/* 🌟 SAFE: Guarded author image check */}
              {data.user?.img && (
                <Image
                  src={data.user.img}
              ...
              {/* 🌟 SAFE: Guarded sidebar author name */}
              <Link className="text-blue-800">
